...
//            //방참가 메시지 보내기
//            chatService.sendMsg(setProtocol(CreateRoom,myid,null,null,null));
        }
...
//        chatService.ActivityShowing = true;
        ...
        //상담 확인 업데이트
        ConsultDB consultDB = new ConsultDB(activity_chatting.this, "Consulting.db", null, 1);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (rjo.getBoolean("result")) {
                    Toast.makeText(activity_chatting.this, rjo.getString("msg"), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(activity_chatting.this, rjo.getString("msg"), Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
